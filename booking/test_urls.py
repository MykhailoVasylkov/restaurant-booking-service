...
class ReservationURLPatternsTest(TestCase):
    ...
    def test_booking_page_url_resolves(self):
        ...
        self.assertEqual(
            resolver.func, booking_page,
            msg="URL 'booking/' should call booking_page view"
        )
    ...
    def test_edit_review_url_resolves(self):
        ...
        self.assertEqual(
            resolver.func, edit_booking,
            msg="URL 'edit/<pk>' should call edit_booking view"
        )
    ...
    def test_delete_booking_url_resolves(self):
        ...
        self.assertEqual(
            resolver.func, delete_booking,
            msg="URL 'delete/<pk>' should call delete_booking view"
        )
