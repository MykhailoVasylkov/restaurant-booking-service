...
class TestReviewForm(TestCase):
    ...
    def test_form_invalid_rating(self):
        ...
        self.assertFalse(review_form.is_valid(), msg="Form should be invalid with rating > 5")
    ...
    def test_form_missing_rating(self):
        ...
        self.assertFalse(review_form.is_valid(), msg="Form should be invalid without rating")
    ...
    def test_form_empty_body(self):
        ...
        self.assertFalse(review_form.is_valid(), msg="Form should be invalid with empty body")