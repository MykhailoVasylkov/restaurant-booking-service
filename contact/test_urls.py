...
class ReviewURLPatternsTest(TestCase):
    ...
    def test_review_create_url_resolves(self):
        ...
        self.assertEqual(
            resolver.func, review_create,
            msg="URL 'contact/' should call review_create view"
        )
    ...
    def test_edit_review_url_resolves(self):
        ...
        self.assertEqual(
            resolver.func, edit_review,
            msg="URL 'edit/<pk>' should call edit_review view"
        )
    ...
    def test_delete_review_url_resolves(self):
        ...
        self.assertEqual(
            resolver.func, delete_review,
            msg="URL 'delete/<pk>' should call delete_review view"
        )
